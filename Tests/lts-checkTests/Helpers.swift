...
extension XCTestCase {
	...
	/** Important: I think this function only works if there are not too much output data… */
	func runTargetExecutable(_ name: String) throws -> (Int32, Process.TerminationReason, Data, Data) {
...
#else
		struct NoProcessClass : Error, LocalizedError {var errorDescription: String {"This test must not run on macCatalyst as it does not have Process."}}
